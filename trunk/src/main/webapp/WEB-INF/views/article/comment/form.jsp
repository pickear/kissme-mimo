...
<input type="hidden" name="article.id" value="${articleComment.article.id }" />
 <!--content start-->
<div class="content">
<div class="table">
<div class="contentNav"><h1>文章留言管理</h1></div>
 <div class="tips"><img src="${ctx}/resources/img/tips.gif" align="left" />&nbsp;所有带有<span class="red">*</span>为必填项</div>
...
<td colspan="2"><form:input path="article.title" readonly="true" cssClass="input5 fontMar"/></td>
</tr>
<tr>
<td width="150" align="right" nowrap="nowrap">留言者：</td>
<td colspan="2"><form:input path="author" readonly="true" cssClass="input5 fontMar"/></td>
</tr>
<!-- <tr> -->
