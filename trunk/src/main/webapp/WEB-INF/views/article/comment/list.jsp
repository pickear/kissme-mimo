...
<div class="chsm"><span>文章评论管理</span></div>
<div class="czsrt">
<span>你可以：</span>
...
<div class="rcd_td">
  ...
  <c:choose>
  	...
  	<tr>
    <td style="border-left:0;"><input type="checkbox" name="items" id="checkbox" value="${articleComment.id}"/></td>
    <td>${fn:substring(articleComment.article.title,0,15)}&nbsp;</td>
    <td>${articleComment.author }&nbsp;</td>
    <td>${articleComment.status == 1 ? '[正常]&nbsp;' : '[审核中]&nbsp;' }&nbsp;</td>
