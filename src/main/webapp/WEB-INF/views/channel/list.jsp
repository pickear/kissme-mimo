...
<div class="chsm"><span>栏目管理</span></div>
<div class="czsrt">
<span>你可以：</span>
...
<div class="rcd_td">
  ...
  <c:choose>
  	...
  	<tr>
    <td style="border-left:0;"><input type="checkbox" name="items" id="checkbox" value="${channel.id}"/></td>
    <td>${channel.name}&nbsp;</td>
    ...
    <td>
    	<a href="${ctx }/${channel.path}" target="_blank" >浏览</a>&nbsp;
