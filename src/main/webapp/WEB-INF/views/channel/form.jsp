...
<div class="content">
<div class="table">
<div class="contentNav"><h1>栏目管理</h1></div>
...
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red" style="color: red;" >*</span>访问路径：</td>
<td colspan="2">
	<form:input path="path" cssClass="input6 fontMar" id="path"/>&nbsp;（如：aboutus）
</td>
</tr>
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red" style="color: red;" >*</span>排序：</td>
<td colspan="2">
	<form:input path="priority" cssClass="input6 fontMar" id="sort"/>&nbsp;（数值越<span class="red" style="color: red;" >高</span>，越靠<span class="red" style="color: red;" >前</span>显示）
</td>
</tr>
<tr>
...
<form:select path="father.id">
	...
	<form:options items="${channelViews}" itemValue="id" itemLabel="levelName"/>
</form:select>
</td>
</tr>
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red" style="color: red;" >*</span>栏目显示模板：</td>
<td colspan="2">
...
<td colspan="2">
<form:select path="articleTemplate.id">
	<form:option value="">请选择</form:option>
	<form:options items="${templates}" itemValue="id" itemLabel="name"/>
</form:select>
</td>
...
<td colspan="2">
	<form:textarea path="about" rows="50" cols="120" />
</td>
</tr>
</tbody>
</table>
