...
<body>
<form:form action="${ctx }/home-conf/edit/" method="post" modelAttribute="homeConf" id="form">
<input type="hidden" name="_method" value="${_method }" />
 <!--content start-->
<div class="content">
<div class="table">
<div class="contentNav"><h1>首页配置</h1></div>
<div class="tips">
...
<tbody>
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red" style="color: red;" >*</span>网页标题：</td>
<td colspan="2">
	<form:input path="title" cssClass="input5 fontMar" />
</td>
</tr>
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red" style="color: red;" >*</span>模板：</td>
<td colspan="2">
<form:select path="template.id">
