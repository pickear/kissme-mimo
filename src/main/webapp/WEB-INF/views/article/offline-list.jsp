...
<div class="chsm"><span>文章回收站</span></div>
<div class="czsrt">
<span>你可以：</span>
...
<span>你可以：</span>
<span class="dist">名称：</span><input name="params[pathname]" value="${page.params.actor}" type="text" /><input class="tjbtn" type="submit" value="提交" />
</div>
